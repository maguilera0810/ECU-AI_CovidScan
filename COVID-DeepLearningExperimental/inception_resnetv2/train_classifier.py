...
parser.add_argument('--weightspath', default='inception_resnetv2/saves', type=str, help='Path to output folder')
parser.add_argument('--metaname', default='model.meta_train', type=str, help='Name of ckpt meta file')
parser.add_argument('--model_config', default='inception_resnetv2/saves', type=str, help='Name of model ckpts')
...
@tf.function
def train_step(images, labels, optimizer, sample_weights):
...
for epoch in range(initial_epochs):
  for i in range(total_batch_train):
    ...
    train_step(images, labels, optimizer, weights)
...
#with open(args.model_config+'/inceptionresnetCOVID_model_config.json', 'w') as json_file:
#    json_file.write(json_config)
# Guardar pesos en el disco
model.save_weights(args.weightspath+'/inceptionresnetCOVID_weights2.h5')

model.save(args.model_config+'/inceptionresnetCOVID_entiremodel_new2.h5')
